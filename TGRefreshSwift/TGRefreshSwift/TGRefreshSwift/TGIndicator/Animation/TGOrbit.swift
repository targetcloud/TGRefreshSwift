...
class TGOrbit: TGIndicatorDelegate {
    ...
    func setupAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        satelliteSize = CGFloat(fmaxf(4, Float(satelliteSize)))
    ...
    func ring1InLayer(_ layer: CALayer, size _: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = TGIndicatorShape.circle.layerWith(size: CGSize(width: coreSize, height: coreSize), color: color)
    ...
    func satelliteInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = TGIndicatorShape.circle.layerWith(size: CGSize(width: satelliteSize, height: satelliteSize), color: color)
