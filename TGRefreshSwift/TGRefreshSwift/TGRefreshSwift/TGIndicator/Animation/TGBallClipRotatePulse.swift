...
class TGBallClipRotatePulse: TGIndicatorDelegate {
    ...
    func bigCircleWith(duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = TGIndicatorShape.ringTwoHalfVertical.layerWith(size: size, color: color)
