...
class TGBallTrianglePath: TGIndicatorDelegate {
    func setupAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Top-center circle
        let topCenterCircle = TGIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-left circle
        let bottomLeftCircle = TGIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-right circle
        let bottomRightCircle = TGIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
